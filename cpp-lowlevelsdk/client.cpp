...
OSLowLevelSdkClient::OSLowLevelSdkClient(const std::string &serverAddress, const std::string &rootCertPath, const std::string &clientCertPath, const std::string &clientKeyPath, const std::string &nodeControllerId) {
    ...
    args.SetSslTargetNameOverride(nodeControllerId + ".nodes.prod.oursky.ai");
