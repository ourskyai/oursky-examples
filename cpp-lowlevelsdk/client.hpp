...
public:
    explicit OSLowLevelSdkClient(const std::string& server_address, const std::string& rootCertPath, const std::string& clientCertPath, const std::string& clientKeyPath, const std::string &nodeControllerId);
