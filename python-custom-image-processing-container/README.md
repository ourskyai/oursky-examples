...
# You can use this feature to enable or disable custom image processing.
# A value of active: true will instruct the Edge Controller to pass images to the container
# A value of active: false will instruct the Edge Controller to skip passing images to the container
